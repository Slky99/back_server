...
public class ApoffresDTO {
    ...
    public ApoffresDTO(int id_offres, String missions, int client, Boolean d_administratif, Boolean d_financier, Boolean cv_formater, Date consultation_date, Timestamp heure, String consultation) {
